  ...
  //------------------------- RETURN --------------------------------------------------------------------------
    ...
    return (
        <Panel title="The structure of this app is as follows" id="start-panel">            
            ...
            <p className="menu-link" onClick={() => toggleDetails("about")} aria-controls="example-collapse-text" aria-expanded={details}>{!details? "more..." : "less..."}</p>
              </div>
              <Collapse in={details === "about"}>
            ...
            <div>
              <div className="menu-panel">
                ...
                <p className="menu-link" onClick={() => toggleDetails("history")} aria-controls="example-collapse-text" aria-expanded={details}>{!details? "more..." : "less..."}</p>
              </div>
              <Collapse in={details === "history"}>
                <div className="menu-details" id="example-collapse-text">
            ...
            <div>
              <div className="menu-panel">
                ...
                <p className="menu-link" onClick={() => toggleDetails("userchats")} aria-controls="example-collapse-text" aria-expanded={details}>{!details? "more..." : "less..."}</p>
              </div>
              <Collapse in={details === "userchats"}>
                <div className="menu-details" id="example-collapse-text">
            ...
            <div>
              <div className="menu-panel">
                ...
                <p className="menu-link" onClick={() => toggleDetails("chat")} aria-controls="example-collapse-text" aria-expanded={details}>{!details? "more..." : "less..."}</p>
              </div>
              <Collapse in={details === "chat"}>
                <div className="menu-details" id="example-collapse-text">
            ...
            <div>
              <div className="menu-panel">
                ...
                <p className="menu-link" onClick={() => toggleDetails("login")} aria-controls="example-collapse-text" aria-expanded={details}>{!details? "more..." : "less..."}</p>
              </div>
              <Collapse in={details === "login"}>
                <div className="menu-details" id="example-collapse-text">
            ...
            <div>
              <div className="menu-panel">
                ...
                <p className="menu-link" onClick={() => toggleDetails("drafts")} aria-controls="example-collapse-text" aria-expanded={details}>{!details? "more..." : "less..."}</p>
              </div>
              <Collapse in={details === "drafts"}>
                <div className="menu-details" id="example-collapse-text">
            ...
            <div>
              <div className="menu-panel">
                ...
                <p className="menu-link" onClick={() => toggleDetails("publish")} aria-controls="example-collapse-text" aria-expanded={details}>{!details? "more..." : "less..."}</p>
              </div>
              <Collapse in={details === "publish"}>
                <div className="menu-details" id="example-collapse-text">
