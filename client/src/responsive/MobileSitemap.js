            ...
            <div>
              ...
              <Collapse in={history}>
                <div className="menu-details" id="example-collapse-text">
                  ...
                  <p className="start-para-details">If you click on the title of a chat it will be displayed in <span className="menu-inside" onClick={() => handleKey("chat")}>"Chat" </span>.</p>
                  ...
                  <p className="start-para-details">If you only hover over the title additional informations about the chat will appear: Tags and a brief description of the chat.</p>
                </div>
              </Collapse>
            </div>
            ...
            <div>
              ...
              <Collapse in={login}>
                <div className="menu-details" id="example-collapse-text">
                  ...
                  <p className="start-para-details">The authorization is at the moment not a safe "https" process, a safe way to log in with your private email address will available in the future. 
            ...
            <p className="menu-link" onClick={() => toggleDetails("drafts")} aria-controls="example-collapse-text" aria-expanded={drafts}>{!drafts? "more..." : "less..."}</p>
              ...
              <Collapse in={drafts}>
                <div className="menu-details" id="example-collapse-text">
                  ...
                  <p className="start-para-details">If you like to edit the draft of your chat you can click "Save changes" when you are done editing, changes will be saved.</p>
                  <p className="start-para-details">"Tags" and "Description" are the parts which will appear on the <span className="menu-inside" onClick={() => handleKey("userchats")}>"Userchats" </span> section when you published your chat.</p>
                </div>
              </Collapse>
            </div>
            ...
            <div>
              ...
              <Collapse in={publish}>
                <div className="menu-details" id="example-collapse-text">
                  ...
                  there you have to set a "chatnumber" and a "date", then click on "Publish chat", it will be displayed in <span className="menu-inside" onClick={() => handleKey("userchats")}>"Userchats" </span>.</p>
